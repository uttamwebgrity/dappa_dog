var rules = {
	...
	'textarea.richtext': function(elt) {
		new Control.RTE(elt, 'js/controls/rte/date_picker', { fileLister: listUserFiles });
	},
	'input.datepicker': function(elt) {
		new Control.DatePicker(elt, { icon: '../date_picker/calendar.png' });
	},
	'input.timepicker': function(elt) {
		new Control.DatePicker(elt, { icon: '../date_picker/clock.png', datePicker: false, timePicker: true });
	},
	'input.datetimepicker': function(elt) {
		new Control.DatePicker(elt, { icon: '../date_picker/calendar.png', timePicker: true, timePickerAdjacent: true, use24hrs: true });
	},
	'input.datetimepicker_es': function(elt) {
		new Control.DatePicker(elt, { icon: '../date_picker/calendar.png', locale:'es_AR', timePicker: true });
	},
