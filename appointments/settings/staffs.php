...
function show_staffs(value){
	...
	var ajaxURL="search.php?keywords=" + document.frmsearch.keyword.value +"&type=staffssearch&t=" + Math.random();
...
function del(id,url,name){
 ...
 <div class="breadcrumb">
      	<p><a href="settings/staff.php">Staffs</a> &raquo; Staff List</p>
</div>
...
<?php } ?>
 <div class="pageTopPnl">
        	<div class="searchPnl">
				...
				<?php }	?>
        		<input name="keyword"  value="" type="text"  onkeyup="show_staffs(this.value)" placeholder="Search by name, email, etc" />
            ...
            <div class="buttonPnl"><input name="add_staffs" type="button" value="Add Staff" onclick="location.href='<?=$general_func->admin_url?>settings/staffs-new.php?return_url=<?=urlencode($url)?>'" />
            	<?php } ?> 
       </div>
        </div>
