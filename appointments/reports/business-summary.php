  ...
  <div class="tabPnlContInr">
    ...
    <h3>By Staff:</h3>
      ...
      <ul class="formTwoTot">
        ...
        <h3 style="border:none; margin-top:0; color:#666;">Arindam Bera</h3>
        ...
        <div class="formTwoPnl">
        <h3 style="border:none; margin-top:0; color:#666;">Saikat Das</h3>
          <ul class="formTwoDply">
            <li><span>Unique Customers: </span> $ 112.00</li>
            <li><span>Total Bookings: </span> 4</li>
            <li><span>Services booked: </span>4</li>
    ...
    <h3>By Service:</h3>
      ...
      <ul class="formTwoTot">
        ...
        <div class="formTwoPnl">
        <h3 style="border:none; margin-top:0; color:#666;">Demo [delete or rename]</h3>
          <ul class="formTwoDply">
            <li><span>Unique Customers: </span> $ 112.00</li>
            <li><span>Total Bookings: </span> 4</li>
            <li><span>Services booked: </span>4</li>
        ...
        <div class="formTwoPnl">
        <h3 style="border:none; margin-top:0; color:#666;">Spa</h3>
          <ul class="formTwoDply">
            <li><span>Unique Customers: </span> $ 112.00</li>
            <li><span>Total Bookings: </span> 4</li>
            <li><span>Services booked: </span>4</li>
        ...
        <div class="formTwoPnl">
        <h3 style="border:none; margin-top:0; color:#666;">Groom</h3>
          <ul class="formTwoDply">
            <li><span>Unique Customers: </span> $ 112.00</li>
            <li><span>Total Bookings: </span> 4</li>
            <li><span>Services booked: </span>4</li>
