...
function del(id,url,name){
 ...
 <div class="breadcrumb">
      	<p><a>Reports</a> &raquo; Future Value</p>
</div>
...
<div class="tabPnlCont">
  <div class="tabPnlContInr">
    ...
    <p><strong>Friday, April 22, 2011 - Monday, July 22, 2013</strong></p>
    <h3>By Staff:</h3>
      <div class="row">
        <div class="formTwoPnl">
        <h3 style="border:none; margin:0; color:#666;">Arindam Bera</h3>
          <ul class="formTwoDply">
            <li><span>Unique Customers: </span> $ 112.00</li>
            <li><span>Total Bookings: </span> 4</li>
            <li><span>Services booked: </span>4</li>
            <li><span>New Customers: </span>4</li>
            <li><span>Online bookings: </span>4</li>
            <li><span>$: </span>112.00</li>
          </ul>
        </div>
        <div class="formTwoPnl">
        <h3 style="border:none; margin:0; color:#666;">Saikat Das</h3>
          <ul class="formTwoDply">
            <li><span>Unique Customers: </span> $ 112.00</li>
            <li><span>Total Bookings: </span> 4</li>
            <li><span>Services booked: </span>4</li>
      ...
      <ul class="formTwoTot">
            <li><strong class="tot">Total :</strong></li>
            <li><span>Unique Customers: </span> $ 112.00</li>
            <li><span>Total Bookings: </span> 4</li>
            <li><span>Services booked: </span>4</li>
            <li><span>New Customers: </span>4</li>
    ...
    <h3>By Service:</h3>
      <div class="row">
        ...
        <div class="formTwoPnl">
        <h3 style="border:none; margin:0; color:#666;">Demo [delete or rename]</h3>
          <ul class="formTwoDply">
            <li><span>Unique Customers: </span> $ 112.00</li>
            <li><span>Total Bookings: </span> 4</li>
            <li><span>Services booked: </span>4</li>
        ...
        <div class="formTwoPnl">
        <h3 style="border:none; margin:0; color:#666;">Spa</h3>
          <ul class="formTwoDply">
            <li><span>Unique Customers: </span> $ 112.00</li>
            <li><span>Total Bookings: </span> 4</li>
            <li><span>Services booked: </span>4</li>
        ...
        <div class="formTwoPnl">
        <h3 style="border:none; margin:0; color:#666;">Groom</h3>
          <ul class="formTwoDply">
            <li><span>Unique Customers: </span> $ 112.00</li>
            <li><span>Total Bookings: </span> 4</li>
            <li><span>Services booked: </span>4</li>
