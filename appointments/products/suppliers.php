...
if(isset($_GET['action']) && $_GET['action']=='delete'){	
	$db->query_delete("product_supplier","id='".$_REQUEST['id'] ."'");	
	$_SESSION['msg']="Your selected supplier record deleted!";
...
(min-device-width: 768px) and (max-device-width: 1024px)  {
	...
	*/
	...
	td:nth-of-type(4):before { content: "Landline No."; }
	td:nth-of-type(5):before { content: "Physical Address line 1"; }
...
function show_suppliers(value){
	...
	var ajaxURL="search.php?keywords=" + document.frmsearch.keyword.value +"&type=suppliersearch&t=" + Math.random();
...
function del(id,url,name){
	var a=confirm("Are you sure, you want to delete supplier: '" + name +"'?")
    if (a){
 ...
 <div class="breadcrumb">
      	<p><a href="products/suppliers.php">Suppliers</a> &raquo; Supplier List</p>
</div>
...
<?php } ?>
 <div class="pageTopPnl">
        	<div class="searchPnl">
        		...
        		<input name="keyword"  value="" type="text"  onkeyup="show_suppliers(this.value)" placeholder="Search by name, mobile number, etc" /><input name="submit" id="submit" style="display: none;" type="button" value="Clear Search" onclick="location.href='<?=$_SERVER['PHP_SELF']?>'" />
        		 </form>
        		</div>
            <div class="buttonPnl"><input name="add_customer" type="button" value="Add Supplier" onclick="location.href='<?=$general_func->admin_url?>products/suppliers-new.php?return_url=<?=urlencode($url)?>'" /> 
