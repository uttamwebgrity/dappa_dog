...
class Date_Calc {
    ...
    function toDaysName($day="",$month="",$year=""){
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
            $month = Date_Calc::dateNow("%m");
		...
		$toDaysSecond=mktime(0,0,0,$month,$day,$year);
		
        return date("D, j F Y",$toDaysSecond);
    } 
	function toDaysFullName($day="",$month="",$year=""){
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
            $month = Date_Calc::dateNow("%m");
